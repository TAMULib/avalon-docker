...
envsubst '$env_rtmp_avalon_url,$env_kaltura_streaming_port,$env_master_file_location,$env_proxy_pass_url,$env_resolver_ip' < /etc/nginx/nginx.conf.template > /etc/nginx/nginx.conf
